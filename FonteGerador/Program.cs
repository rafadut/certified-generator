            ...
            try
            {
                ...
                if (enviarEmails)
                {
                    ...
                    for (int i = 0; i < quantidadeParticipantes; i++)
                    {
                        ...
                        msg.Body = saudacao + participantes[i].Nome + "!"
                            + Environment.NewLine
                            + Environment.NewLine
                        ...
                        if (enderecoEmailRemetente.Contains("vivaedeixeviver"))
                        {
                            client.Host = "smtp.vivaedeixeviver.org.br";
                        }
                        else if (enderecoEmailRemetente.Contains("gmail"))
                        {
